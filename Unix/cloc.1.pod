#   Copyright
#
#      Copyright (C) 2017 Al Danial <al.danial@gmail.com>.
...
invoke 'git ls-files'
to get a file list and 'git submodule status' to get a
list of submodules whose contents will be ignored.
If VCS is 'svn' then
...
is Copyright (C) 2006-2017 <al.danial@gmail.com>.
